...
public class Listing10_10PalindromeIgnoreNonAlphanumeric {
    /** Main method */
    ...
    public static String filter(String s){
        ...
        for (int i = 0; i < s.length(); i++) {
            if (Character.isLetterOrDigit(s.charAt(i))){
                stringBuilder.append(s.charAt(i));              //add letter
            }
        }
    ...
    /** Create a new string by reverseing a specified string */
